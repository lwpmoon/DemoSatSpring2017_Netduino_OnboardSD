...
namespace DemoSat2016Netduino_OnboardSD.Drivers {
    public class LiquidCrystalI2C
    {
        ...
        private readonly object LCDLock;
        ...
        public LiquidCrystalI2C(byte lcd_Addr, byte lcd_cols, byte lcd_rows)
        {
            LCDLock = new object();
            ...
            _slaveConfig = new I2CDevice.Configuration(lcd_Addr, MaxFreq);
            
            //_I2C = new I2c(lcd_Addr, MAX_FREQ);
            begin(_cols, _rows);
        }
        ...
        private void expanderWrite(byte _data) {
            I2CBus.GetInstance().Write(_slaveConfig, new byte[] {(byte) (_data | _backlightval)},1000);
